...
LOAD DATA LOCAL INFILE '"F:\\CFP\\Database_Management\\resources\\CpuLogData2019-11-17-new.csv"' INTO TABLE temporary_MIS FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 ROWS
(
    Date_Time ,
	Cpu_Count ,
	Cpu_Working_Time ,
